  ...
  return (
    <div>
      <NavbarItem className="bg-transparent text-white font-bold">
        <Link className="cursor-pointer text-lg hover:text-blue-300 transition duration-300 ease-in-out" onClick={onOpenDescargas}>
          DESCARGAS
        </Link>
        <Modal
              ...
              <Tabs aria-label="Options">
                  ...
                  <Card className="mt-4 shadow-md rounded-lg">
                    <CardBody className="bg-gray-50 p-4 rounded-lg shadow-sm">
                      <div className="flex flex-col gap-2">
                        <p className="font-semibold">Descargar: <Link href="https://www.mediafire.com/file/nz9ik3ltaj6ev5y/Cliente_Club_5.exe/file"  className="text-blue-500 hover:underline">MEDIAFIRE</Link></p>
                ...
                >
                  <Card className="mt-4 shadow-md rounded-lg">
                    <CardBody className="bg-gray-50 p-4 rounded-lg shadow-sm">
                      <div className="flex flex-col gap-2">
                        <p className="font-semibold">Descargar: <Link href="https://mega.nz/file/2wQlQJ5S#2nuN1LRaWYcJU4YFojUI8sbXA7rwGI4lh9j2jLws5a8"  className="text-blue-500 hover:underline">MEGA</Link></p>
                        <div className="font-medium text-gray-700">
                          <p>Requisitos:</p>
                          <ul className="list-disc pl-5">
                          <li>Procesador: 2 Núcleos o más AMD/INTEL</li>
